...
const REGISTER = {
  ...
  programs: [
    ...
    /* ===================================================================== *
     * البرنامج 7 — برنامج بناء القدرات (v4)
     * ===================================================================== */
    {
      id: "p7_capacity",
      name: "برنامج بناء القدرات",
      years: [2026],
      ...
      items: [
        ...
        { id: "p7_i19", stage: "أثر", shape: "matrix",     label: "إجمالي قيمة عقود الإسناد الحكومي التي فازت بها الجمعيات", source: "ركين", status: "fetch", notes: "وثيقة منهجية ن4 (S39، سجلات/أثر). قيمة العقود الفائزة — قد لا تُحفظ مركزياً لدى ركين/الجمعيات (permission-gated)." }
      ]
    }
  ]
};
